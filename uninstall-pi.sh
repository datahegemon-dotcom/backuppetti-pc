#!/usr/bin/env bash
#
# BackupPetti Box — uninstaller for Raspberry Pi / Linux.
#
...
#
# Run it with:
#   curl -fsSL https://datahegemon-dotcom.github.io/backuppetti-pc/uninstall-pi.sh | sudo bash
#
set -euo pipefail
...
if [ "$(id -u)" -ne 0 ]; then
  ...
  echo "  curl -fsSL https://datahegemon-dotcom.github.io/backuppetti-pc/uninstall-pi.sh | sudo bash"
  exit 1
fi
